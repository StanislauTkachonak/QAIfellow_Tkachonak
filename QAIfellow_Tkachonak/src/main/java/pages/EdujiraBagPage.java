...
public class EdujiraBagPage {
    public final static SelenideElement createTask2 = $x("//a[@title=\"Создать новую задачу ( Нажмите 'c' )\"]").as("Кнопка создание задачи");
    public final static SelenideElement changeTask2 = $x("//input[@id=\"issuetype-field\"]").as("Кнопка изменения задачи");
    ...
    public final static SelenideElement clickOnVersion1 = $x("//optgroup[@label='Невыпущенные версии']//option[contains(text(),'Version 2.0')]").as("Поле версия ошибки");
    public final static SelenideElement clickOnTags = $x("//div[@class=\"jira-multi-select long-field\"]").as("Поле тег ошибки");
    public final static SelenideElement confirmCreateTask2 = $x("//div[@class=\"jira-multi-select long-field\"]").as("Кнопка подтверждения создания задачи");
    ...
    public final static SelenideElement taskStatus = $x("(//div//strong[@title=\"Статус\"]//following::span//span)[1]").as("Поле статус ошибки");
